  ...
  <div class="main-container">
    <div class="main-header">
      <div class="float-left main-title">
        ...
        <span class="bold">VForm 3</span> {{ $t("application.productTitle") }}
      ...
      <div class="float-right external-link">
        ...
        <a
          ...
          target="_blank"
          ><svg-icon icon-class="github" />{{ $t("application.github") }}</a
        >
        <a
          v-if="showLink('externalLink')"
          href="javascript:void(0)"
          ...
          target="_blank"
          ><svg-icon icon-class="document" />{{ $t("application.document") }}</a
        >
        <a
          v-if="showLink('externalLink')"
          href="javascript:void(0)"
        ...
        <a
          ...
          target="_blank"
        >
          {{ $t("application.subscription") }}<i class="el-icon-top-right"></i
        ></a>
      </div>
    </div>
