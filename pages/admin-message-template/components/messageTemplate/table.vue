...
const { tableConfig, tableEvent, tableRef, reload } = useVxeTable({
  ...
  api: async (params: any) => {
    ...
    return await listProvider?.getListApi({ ...params, ...extraParams })
  },
  columns: [
    {
      field: 'templateName',
      title: 'message_templateName',
      fixed: 'left'
    },
    {
      field: 'usages',
    ...
    {
      field: 'language',
      title: 'userSetting_language'
    },
    {
      field: 'whatsAppStatus',
      title: 'message_templateStatus',
      type: 'html',
      formatter: ({ cellValue }) => {
...
function handleFilterFormChange(params: any) {
  extraParams = params
}

defineExpose({
  reload, handleFilterFormChange
})
</script>
