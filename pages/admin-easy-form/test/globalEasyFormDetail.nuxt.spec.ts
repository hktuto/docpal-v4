...
describe('[admin-easy-form]EasyFormDetailName', () => {
  ...
  it('handles error during name change', async () => {
    ...
    expect(routerProvider?.message.error).toHaveBeenCalledWith('dpMsg_error')
  })
})
...
describe('[admin-easy-form]EasyFormDetailPreview', () => {
  ...
  it('copies URL to clipboard', async () => {
    ...
    expect(routerProvider?.message.success).toHaveBeenCalledWith('dpTip.urlCopied')
  })
  it('copies embed code to clipboard', async () => {
    wrapper.vm.handleCopyIframe()
    expect(routerProvider?.message.success).toHaveBeenCalledWith('dpTip.embedCodeCopied')
  })
