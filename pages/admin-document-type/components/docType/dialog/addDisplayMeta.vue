<template>
<el-dialog v-model="state.visible" :title="state.isEdit ? $t('docTypeDetail_editDisplayMeta') : $t('docTypeDetail_addDisplayMeta')"
    ...
    <template #footer>
        ...
        <el-button v-show="!state.isEdit"  type="primary" :loading="state.loading" @click="handleSubmit(true)">{{$t('common_addMore')}}</el-button>
    </template>
</el-dialog>
</template>
