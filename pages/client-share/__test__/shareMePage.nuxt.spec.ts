...
import { InternalShareMePage } from '#components'
import { VxeGrid } from 'vxe-table'
import { clientApi } from './mock/api'

describe('[client-share-internal]ShareMePage', () => {
  let wrapper: any
  beforeEach(() => {
    vi.clearAllMocks()
    wrapper = mount(InternalShareMePage, {
      global: {
        components: { VxeGrid },
        provide: {
  ...
  it('should handleFilterFormChange the component correctly', async () => {
    ...
    expect(clientApi.api.postInternalshareMe).toHaveBeenCalled()
  })
