<template>
  ...
  >
    ...
    <template #footer>
      <el-button id="adminFolderCabinetSettingCreateNewFolderCabinetSubmit" type="primary" :loading="state.loading"
                 @click="handleSubmit">
        {{ $t("common_submit") }}
      </el-button>
    </template>
...
async function handleSubmit() {
  ...
  let msg = state.isEdit ? t('folder_cabinetEditSuccessMsg') : t('folder_cabinetCreatedSuccessMsg')
