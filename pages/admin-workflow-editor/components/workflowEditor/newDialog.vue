...
const nameRule = [
    {required: true, message: t('workflow_editorWorkflowNameRequiredMsg'), trigger: 'blur'}
]
...
<template>
    <el-dialog v-model="state.visible" :title="$t('workflow_editorCreate')"
               :close-on-click-modal="false" distroy-on-close
    >
        <el-form ref="formRef" :model="state.form" label-position="top"
                 class="demo-ruleForm" status-icon
        >
            <el-form-item :label="$t('workflowEditor.name')" prop="name" :rules="nameRule">
