...
watch(() => props.modelValue, v => { link.value = { label: v?.label || '', url: v?.url || '' } })
function emitValue() { emit('update:modelValue', { ...link.value }) }
</script>
<style lang="scss" scoped>
.link-editor { display: flex; flex-direction: column; }
</style> 
