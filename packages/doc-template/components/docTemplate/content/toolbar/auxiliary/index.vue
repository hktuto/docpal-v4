...
<template>
  <div class="font-style-toolbar">
    <el-button
      v-tooltip="t('docTemplate.utils.HorizontalLine')"
      @click="addHorizontalLine"
    >
      {{ $t('docTemplate.utils.HorizontalLine') }}
    </el-button>
    <el-button
      v-tooltip="t('docTemplate.utils.toggleTaskList')"
    ...
    <!-- font link -->
    <el-button
      v-tooltip="t('docTemplate.utils.link')"
      style="width: 38px"
      @click="openSetLinkDialog"
    >
      <p>🔗</p>
    </el-button>
    <!-- set image   -->
    <el-button
      v-tooltip="t('docTemplate.utils.image')"
      @click="openSetImageDialog"
    >
