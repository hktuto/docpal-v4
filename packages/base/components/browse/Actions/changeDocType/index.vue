        ...
        <el-dialog class="scroll-dialog" v-model="dialogOpened" append-to-body 
            ...
            <main>
                <div v-if="state.doc && state.doc.properties">
                    ...
                    <BrowseActionsChangeDocTypeCopyItem v-if="state.doc && state.doc.properties && state.doc.properties['file:content']" :label="$t('docInfo.fileExtension')" :value="state.doc?.properties['file:content']['mime-type']"/>
