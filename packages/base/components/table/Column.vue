    ...
    <el-table-column v-else v-bind="col">
        ...
        <template v-else-if="col.moreActionSlot"  #default="{ row, $index }">
            ...
            <el-dropdown  @command="(command) => handleAction(command, { row, $index })">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <slot :slotName="col.moreActionSlot" :row="row" :index="$index"></slot>
                        <!-- <el-dropdown-item v-for="(act, index) in col.moreActions" :key="act.command" :command="act.command">
                            <template v-if="act.prefixIcon">
                                <SvgIcon class="el-icon--left" :src="act.prefixIcon"></SvgIcon>
                            </template>
                            {{ act.text }}
                        </el-dropdown-item> -->
                    </el-dropdown-menu>
